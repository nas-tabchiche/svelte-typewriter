...
const getMatchingLetters = (elementWithScrambledText) => elementsToScramble.find((element) => element.currentNode === elementWithScrambledText);
...
const scrambleLetters = (element) => {
    ...
    const scrambledText = element.innerHTML
        ...
        const foundMatchingLetterOrSpace = matchingLetters.includes(letterIdx) ||
